...
## Environments
- Preview: https://main--bwb1066-patagonia--aemysites.aem.page/
- Live: https://main--bwb1066-patagonia--aemysites.aem.live/
...
1. Open the `bwb1066-patagonia` directory in your favorite IDE and start coding :)
